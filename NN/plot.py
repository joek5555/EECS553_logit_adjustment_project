...
class Plotter:
    def __init__(self, stats=[], name='NN'):
        self.stats = stats
        self.name = name
        self.axes = self.make_nn_training_plot()

    def make_nn_training_plot(self):
        """
    ...
    def log_nn_training(self, epoch):
        """
    ...
    def update_nn_training_plot(self, epoch):
        """
    ...
    def save_nn_training_plot(self):
        """
